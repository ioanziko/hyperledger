...
setupMSP() {
    ...
    mkdir -p /etc/hyperledger/client/$ORG_NAME/admin/msp/tls
    
    CA_FILENAME=`ls -A /etc/hyperledger/client/$ORG_NAME/admin/msp/tlsintermediatecerts`
    cp /etc/hyperledger/client/$ORG_NAME/admin/msp/tlsintermediatecerts/$CA_FILENAME /etc/hyperledger/client/$ORG_NAME/admin/msp/tls/ca.pem
    cp /etc/hyperledger/client/$ORG_NAME/admin/msp/tlsintermediatecerts/$CA_FILENAME /etc/hyperledger/client/$ORG_NAME/admin/msp/cacerts/$CA_FILENAME
    KEY_FILENAME=`ls -A /etc/hyperledger/client/$ORG_NAME/admin/msp/keystore/`
    cp /etc/hyperledger/client/$ORG_NAME/admin/msp/keystore/$KEY_FILENAME /etc/hyperledger/client/$ORG_NAME/admin/msp/tls/key.pem
    cp /etc/hyperledger/client/$ORG_NAME/admin/msp/signcerts/cert.pem /etc/hyperledger/client/$ORG_NAME/admin/msp/tls/cert.pem    
}
...
usage() {
    echo    "Usage:     ./register-enroll-admin   ORG_NAME   CA_ADDRESS   MAX_ENROLLMENTS"
